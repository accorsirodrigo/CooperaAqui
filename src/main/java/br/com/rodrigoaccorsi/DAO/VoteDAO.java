...
@Component
public class VoteDAO implements DAOPattern {

	private MongoCollection<Document> collection = 
			ConnectionFactory.getInstance()
					.getCollection(ConnectionFactory.collections.votos.name());
	...
	public FindIterable<Document> getAllByVotationId(String objectId) {
		return collection.find(Filters.eq("votationId", objectId));
	}
}
